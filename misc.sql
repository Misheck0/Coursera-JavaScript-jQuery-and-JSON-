...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2025 at 10:19 PM
...
(7, '<b>Volvo Bold</b>', 'dd', 1994, 59062),
(8, 'Ferrari\'; DROP TABLE autos;\'-- ?', 'jeep', 2015, 338364),
(9, 'Porsche', 'jj', 1997, 135942),
(11, 'Bluecar, SAS\'; DROP TABLE autos;\'-- ?', 'dd', 1998, 110484),
(12, 'BMW', 'dd', 2001, 127543),
(13, 'FCA Italy Bold', 'ddd', 1979, 108758),
(14, 'mishe', '', 2021, 1223),
(15, 'Authorless', 'Pontifice', 80, 16);
...
--
ALTER TABLE `autos`
  MODIFY `auto_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
